...
export function convertRawSetToQuizSet(rawSet: RawSangathitSet): QuizSet {
  ...
  const questions: Question[] = rawSet.questions.map((q, idx) => {
    ...
    if (qNum >= 1 && qNum <= 5) {
      category = 'GK';
      syllabusModule = 'भूगोल, जनसङ्ख्या र वातावरण';
    } else if (qNum >= 6 && qNum <= 10) {
      category = 'GK';
      syllabusModule = 'इतिहास, संस्कृति र सामाजिक व्यवस्था';
    } else if (qNum >= 11 && qNum <= 15) {
      category = 'Economics';
      syllabusModule = 'आर्थिक विकास, १६ औँ योजना र सूचकहरू';
    } else if (qNum >= 16 && qNum <= 20) {
      category = 'Law';
      syllabusModule = 'संविधान, कानुन र सङ्घीय शासन';
    } else if (qNum >= 21 && qNum <= 25) {
      category = 'GeneralAwareness';
      syllabusModule = 'अन्तर्राष्ट्रिय सम्बन्ध र सङ्घसंस्थाहरू';
    } else if (qNum >= 26 && qNum <= 30) {
      category = 'Computer';
      syllabusModule = 'विज्ञान, ICT र समसामयिक';
    } else if (qNum >= 31 && qNum <= 35) {
      category = 'Management';
      syllabusModule = 'कार्यालय सञ्चालन र सार्वजनिक व्यवस्थापन';
    } else if (qNum >= 36 && qNum <= 40) {
      category = 'PublicEnterprises';
      syllabusModule = 'सार्वजनिक संस्थान सम्बन्धी ज्ञान';
    } else if (qNum >= 41 && qNum <= 45) {
      category = 'Mathematics';
      syllabusModule = 'व्यावहारिक गणित तथा वित्तीय गणना';
    } else if (qNum >= 46 && qNum <= 48) {
      category = 'English';
      syllabusModule = 'भाषा परीक्षण (अङ्ग्रेजी)';
    } else if (qNum >= 49 && qNum <= 50) {
      category = 'Nepali';
      syllabusModule = 'भाषा परीक्षण (नेपाली)';
    }
