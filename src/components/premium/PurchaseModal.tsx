...
export const PurchaseModal: React.FC<PurchaseModalProps> = ({ note, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/75 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6 animate-fadeIn overflow-y-auto">
      <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-xl w-full border border-slate-200 dark:border-slate-800 p-5 sm:p-7 space-y-5 shadow-2xl relative my-auto">
        ...
        {step === 'checkout' ? (
          <>
            {/* Header Title */}
            <div>
              <span className="px-3 py-1 rounded-full bg-[#0B2046]/10 dark:bg-blue-900/40 text-[#0B2046] dark:text-blue-300 text-xs font-bold">
            ...
            <div className="space-y-1.5">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 text-xs rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white uppercase font-bold focus:outline-none focus:border-[#0B2046] disabled:opacity-60"
                />
                <button
                  onClick={handleApplyCoupon}
                  disabled={couponApplied || !couponCode.trim()}
                  className="px-4 py-2 rounded-xl bg-[#0F172A] text-white font-bold text-xs hover:bg-[#1E293B] disabled:opacity-50 transition cursor-pointer"
                >
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                >
                  ...
                  <span className="text-xs font-bold text-slate-900 dark:text-white">eSewa QR</span>
                  <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-semibold">इ-सेवा</span>
                </button>
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-[#0B2046] text-white font-black text-xs flex items-center justify-center shadow">
                    <Building2 className="w-4 h-4" />
                  </div>
                  <span className="text-xs font-bold text-slate-900 dark:text-white">Bank Transfer</span>
                  <span className="text-[10px] text-blue-600 dark:text-blue-400 font-semibold">RBB / QR</span>
                </button>
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-purple-600 text-white font-black text-xs flex items-center justify-center shadow">
                    K
                  </div>
                  <span className="text-xs font-bold text-slate-900 dark:text-white">Khalti QR</span>
                  <span className="text-[10px] text-purple-600 dark:text-purple-400 font-semibold">खल्ती</span>
                </button>
              </div>
            </div>

            {/* 2. QR Code & Merchant Payment Card */}
            <div className="p-4 rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800/80 dark:to-slate-800/40 border border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row items-center gap-4">
              {/* Realistic Vector QR Code */}
              <div className="w-36 h-36 bg-white p-2.5 rounded-2xl border-2 border-slate-300 dark:border-slate-600 shadow-sm flex flex-col items-center justify-center shrink-0 relative">
            ...
            <div className="space-y-1.5">
              ...
              {receiptImage ? (
                ...
                <div
                  ...
                  className="p-4 border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-2xl text-center cursor-pointer hover:border-[#0B2046] dark:hover:border-blue-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition flex flex-col items-center justify-center gap-1.5"
                >
            ...
            <button
              ...
              disabled={isProcessing}
              className="w-full py-3.5 bg-[#DC2626] hover:bg-[#B91C1C] text-white font-black rounded-2xl shadow-lg shadow-red-900/30 flex items-center justify-center gap-2 text-xs sm:text-sm transition-all transform active:scale-98 disabled:opacity-50 cursor-pointer"
            >
              {isProcessing ? (
                <>
